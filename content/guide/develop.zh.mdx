...
![File Structure](/images/guide-file-structure.png)
...
![Console Logs](/images/guide-dev-console-logs.png)

**Vercel 日志**

![Vercel Logs](/images/guide-dev-logs-vercel.png)

## 如何批量导入数据

Mkdirs 使用 [Sanity](https://www.sanity.io/) 作为内容管理系统，因此如果你想要批量导入数据，那么你需要将数据导入到 Sanity，导入之前建议您先阅读 [Sanity 文档](/zh/guide/sanity) 中提供的资料了解 Sanity 的基本概念和用法。
...
如果您按照 [安装](/zh/installation) 中的步骤操作，并且有一个名为 `@your-github-username/your-mkdirs` 的仓库。
...
现在，将上游 `main` 分支的更改合并到您的本地 `main` 分支：
 ...
 ![Sync Code](/images/guide-sync-code.png)
  </Step>
  <Step>
    ### 解决冲突（如果有）
