...
![Config information](/images/guide-config-website.png)
...
For example, if you have changed the name/title/subtitle/menus/logo/theme, your directory website may look like this.

![Config information](/images/guide-config-website-2.png)
