...
<Cards>
  <Card title="Start writing" href="/getting-started" icon={<Rocket />}>
    Learn the project structure and publish your first page.
  </Card>
  <Card title="Authoring components" href="/guides/components" icon={<Blocks />}>
    Use callouts, steps, tabs, cards, file trees, and video embeds.
  </Card>
  <Card title="Write maintainable docs" href="/guides/authoring" icon={<FileText />}>
