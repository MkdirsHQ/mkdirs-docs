...
如果您是 Sanity 的新手，您可以从 [Sanity 课程](https://www.sanity.io/learn) 开始学习，特别是以下两个课程：

- [课程：Sanity 入门](https://www.sanity.io/learn/course/day-one-with-sanity-studio)
- [课程：Sanity 数据类型化](https://www.sanity.io/learn/course/typescripted-content)

这些课程是免费的，将帮助您了解如何使用 Sanity，以下内容都是基于这些课程。
