...
3. Get the product price id
    ...
    - Go to the product detail page, click the button "..." in the pricing section.
...
4. Get the webhook secret
    ...
    - Enter the endpoint URL where Stripe will send events to, for example, `https://your-domain.com/api/stripe`.
    - Set the webhook secret and set it to the `.env` file.
