...
1. Determine the AI model to use
   ...
   <Aside type="tip">
      ...
      2、If you want to use other AI models, please refer to the documentation of [Vercel AI SDK](https://sdk.vercel.ai/), add the dependency library of other AI models, and then configure it in Mkdirs.
   </Aside>
